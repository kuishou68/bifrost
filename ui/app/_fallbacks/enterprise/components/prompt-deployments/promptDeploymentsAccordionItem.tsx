...
export function PromptDeploymentsAccordionItem({
	...
	return (
		...
		>
			<AccordionTrigger className="text-muted-foreground w-full min-w-0 shrink-0 py-3 pr-1 text-xs font-medium uppercase hover:no-underline [&[data-state=open]>svg]:rotate-180">
