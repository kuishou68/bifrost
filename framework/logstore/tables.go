...
type Log struct {
	...
	SelectedPromptName      string    `gorm:"type:varchar(255)" json:"selected_prompt_name,omitempty"`
	SelectedPromptVersion   string    `gorm:"type:varchar(64)" json:"selected_prompt_version,omitempty"`
